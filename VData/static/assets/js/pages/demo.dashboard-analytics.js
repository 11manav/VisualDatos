/*! function (s) {
    ...
    e.prototype.initCharts = function () {
        ...
        for (var e = new Date, e = function (e, t) {
            ...
            }, o = (new ApexCharts(document.querySelector("#sessions-overview"), e).render(), []), r = 10; 1 <= r; r--) o.push(r + " min ago");
        t = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"], (a = s("#views-min").data("colors")) && (t = a.split(",")), e = {
            chart: {
                height: 150,
                type: "bar",
                stacked: !0
        ...
        }, new ApexCharts(document.querySelector("#views-min"), e).render(), t = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"], e = {
            chart: {
                height: 345,
                type: "radar"
            },
        ...
        }, new ApexCharts(document.querySelector("#sessions-browser"), e).render(), t = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"], e = {
            chart: {
                height: 320,
                type: "bar"
            },
        ...
        }, new ApexCharts(document.querySelector("#country-chart"), e).render(), t = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"], e = {
            chart: {
                height: 269,
                type: "radialBar"
            },
    ...
    }, s.AnalyticsDashboard = new e, s.AnalyticsDashboard.Constructor = e
}(window.jQuery),
function () {
    "use strict";
